    ...
    <div style="height:100%">
        ...
        <div class="dialog">
            <div class="form-select">
                <div class="item-select" :class="{ active: currentProject == p }" v-for="(p, index) in listProject" :key="index" @click="select(p)">
                    <div>
                        {{ p.name }}
                    </div>
                </div>
        ...
        <div class="footer">
            ...
            <div class="submit" @click="currentProject && proceed(currentProject); close();">Oke</div>
        </div>
    </div>
</template>
...
.item-select:hover {
    background-color: #3f84ff24!important;
    border-color: #3f84ff24;
    -webkit-box-shadow: 0 0 0 4px #3f84ff1f;
    box-shadow: 0 0 0 4px #3f84ff1f;
}
.new-name {
